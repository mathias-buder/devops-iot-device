...
F32 SENSE_TS_C::alpha_filter( F32 &current_sample_f32,
                              ...
                              F32  alpha_coeff_f32 )
{
    return (   ( previous_sample_f32 * alpha_coeff_f32           )
...
F32 SENSE_TS_C::alpha_bate_filter( F32& current_sample_f32,
                                   ...
                                   F32  dt_f32 )
{
    this->xk_f32 = this->xk_1 + ( this->vk_1 * dt_f32 );
    this->vk_f32 = this->vk_1;
    ...
    this->xk_1 = this->xk_f32;
    this->vk_1 = this->vk_f32;

    /* Store filtered output ( clamped to a range of 0.0 to 1.0 ) */
    return( CLAMP( this->xk_1, 0.0F, 1.0F ) );
}
